...
PIP_NO_CACHE_DIR=true PIP_ROOT_USER_ACTION=ignore pip install -e ./yoloefork/third_party/CLIP
PIP_NO_CACHE_DIR=true PIP_ROOT_USER_ACTION=ignore pip install -e ./yoloefork/third_party/ml-mobileclip
PIP_NO_CACHE_DIR=true PIP_ROOT_USER_ACTION=ignore pip install -e ./yoloefork/third_party/lvis-api
PIP_NO_CACHE_DIR=true PIP_ROOT_USER_ACTION=ignore pip install -e ./yoloefork
